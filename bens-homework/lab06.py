...
__author__ = "Ben Camburn"
__credits__ = ["Kyle Koch"]  # Your list of helpers
__email__ = "camburjb@mail.uc.edu"  # Your email address
...
def read_eval_print_loop():
    ...
    if not isinstance(me, Player):
        print('Oh no! You need to create a player in lab08.py to start the game.')
        return
...
if __name__ == '__main__':
    #import doctest
    #doctest.run_docstring_examples(Player.take, globals(), verbose=True)
